...
checkboxInput(inputId = "sector_ConsumerDiscretionary", label = "Consumer Discretionary", value = FALSE),
checkboxInput(inputId = "sector_ConsumerStaples", label = "Consumer Staples", value = FALSE),
checkboxInput(inputId = "sector_Energy", label = "Energy", value = FALSE),
checkboxInput(inputId = "sector_Financials", label = "Financials", value = FALSE),
checkboxInput(inputId = "sector_HealthCare", label = "Health Care", value = FALSE),
checkboxInput(inputId = "sector_Industrials", label = "Industrials", value = FALSE),
checkboxInput(inputId = "sector_InformationTechnology", label = "Information Technology", value = FALSE),
checkboxInput(inputId = "sector_Materials", label = "Materials", value = FALSE),
